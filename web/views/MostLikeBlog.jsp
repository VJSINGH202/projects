<%-- 
    Document   : MostLikeBlog
    Created on : Apr 4, 2020, 10:42:21 AM
    Author     : DELL PC
--%>
<%@page import="java.util.List"%>
<%@page import="com.cms.entities.Blog"%>
<%      
     List<Blog> MostLikeBlogList = (List<Blog>) request.getAttribute("mostlikedblog");
%>
                        ...
                        <section id="acion" class="mb-4 bg-white">
                            <div class="container-fluid">
                                <div class="row">
                                    ...
                                    <div class="col-lg-3 col-md-6 mb-md-1">
                                        <a href="<%=application.getContextPath()%>/FrontController?url=user" class="btn btn-outline-primary btn-block">
                                ...
                                <div class="row pt-md-3 mt-md-2 mb-5">  
                                    <div class="col-12 bg-white">
                                        ...
                                        <table class="table table-hover table-responsive">
                                            ...
                                            <tbody>
                                                <% for (Blog tempBlog : MostLikeBlogList) { %>
                                                <tr class="align-items-center">
                                                    ...
                                                    <a href="<%=application.getContextPath()%>/Admin?command=authorblog&bid=<%=tempBlog.getBlogId()%>" class="btn btn-outline-info btn-sm ml-1 mb-sm-1" data-toggle="tooltip" data-placement="top" data-html="true" title="<h6>View Blog</h6>"><i class="fa fa-eye"></i> Blog</a>
